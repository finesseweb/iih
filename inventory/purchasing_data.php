...
$result = db_query("SELECT units FROM ".TB_PREF."stock_master WHERE stock_id=".db_escape($_POST['stock_id']));
$myrow = db_fetch_row($result);

text_row2(_("Suppliers Unit of Measure:"), 'suppliers_uom', $myrow[0], 50, 51);
