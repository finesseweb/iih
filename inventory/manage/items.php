	...
	if ($input_error != 1)
	{
		...
		{ /*so its an existing one */
			update_item($_POST['NewStockID'], $_POST['description'],
				$_POST['long_description'],$_POST['types'],$_POST['to_date'],
				['from_date'],$_POST['warranty'], $_POST['category_id'], $_POST['sub_cat_name'], $_POST['weight'], 
				$_POST['tax_type_id'], get_post('units'),
				get_post('mb_flag'), $_POST['sales_account'],
				$_POST['inventory_account'], $_POST['cogs_account'],
				$_POST['adjustment_account'], $_POST['assembly_account'], 
				$_POST['dimension_id'], $_POST['dimension2_id'],
				check_value('no_sale'), check_value('editable'),check_value('sl_no'));
...
check_row(_("Serial No. Required"), 'sl_no', null);
