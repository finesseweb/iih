...
if (isset($_POST['Process']) && can_process()){
	//echo "<pre>";print_r($_SESSION['adj_items']->line_items);
...
{
	//$id = find_submit($_POST['UpdateItem']);
	//echo "<pre>";print_r($_SESSION['adj_items']);
	
//$_POST['UpdateItem'] = 1;

    if($_POST['UpdateItem'] !='' && check_item_data())
    {
    	//display_error($_POST['UpdateItem']);
    	//echo "<pre>";print_r($_SESSION['adj_items']);
		$id = $_POST['LineNo'];
...
display_adjustment_items(_("Adjustment Items"), $_SESSION['adj_items'],$_POST['employee_id']);
