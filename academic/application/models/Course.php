...
class   Application_Model_Course extends Zend_Db_Table_Abstract
{
	...
	public function getDropDownList1($academic_id) {
	 ...
	 public function getCoursesDropDownList($category_id,$ct_type){
...
//             }
		$select = $this->_db->select()
					->from($this->_name,array('course_id as id','concat(course_master.course_code,"-",course_name) as course_name'))
