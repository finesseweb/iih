...
public function addonCourseReportAction() {
 ...
 $addonCourseItem->update($updateData, array('id=?' => $edit_id));
    ...
    public function verifiedStudentAction() {
        ...
        $this->view->year_id = $yearId['year_id'];
        $this->view->type = $type;
        switch ($type) {
            ...
            case "getDocumentVerifiedStudents":
                ...
                $result = $paymentModel->getdocumentVerifiedRecordByCouse($dept_id,$yearId['year_id']);
             //   echo "<pre>";print_r($result);die;
                $page = $this->_getParam('page', 1);
                $paginator_data = array(
                    'page' => $page,
            ...
            default:
                ...
                $academicYearModel = new Application_Model_AcademicYear();
                $yearId = $academicYearModel->getAcadYearId();
                $ugCourseCountData = $applicantCourseData->getAllScrutinizedUgCourseCount($yearId['year_id']);
               // echo"<pre>";print_r($yearId);exit;
                $pgCourseCountData = $applicantCourseData->getAllScrutinizedPgCourseCount($yearId['year_id']);
                // echo"<pre>";print_r($pgCourseCountData);exit;
                //$this->view->result = $courseCountData;
                $page = $this->_getParam('page', 1);
                $paginator_data = array(
...
//echo "<pre>";print_r($applicantDetails);exit;
    ...
    public function approvedStudentsAction() {
        ...
        switch ($type) {
            ...
            case "getPrincipalApprovedStudents":
                $paymentModel = new Application_Model_ApplicantPaymentDetailModel();
                $dept_id = $this->_getParam("dept_id");
                $result = $paymentModel->getapprovedRecordByCourse($dept_id,$yearId['year_id']);
                //echo "<pre>";print_r($result);die;
                $page = $this->_getParam('page', 1);
                $paginator_data = array(
                    'page' => $page,
    ...
    public function paySlipGeneratedStudentsAction() {
        ...
        switch ($type) {
            ...
            case "getStudents":
                $paymentModel = new Application_Model_ApplicantPaymentDetailModel();
                $dept_id = $this->_getParam("dept_id");
                $result = $paymentModel->getSlipGeneratedRecordByCourse($dept_id,6);
                //echo "<pre>";print_r($result);die;
                $page = $this->_getParam('page', 1);
                $paginator_data = array(
                    'page' => $page,
    ...
    public function icardDetailsAction() {
        ...
        $multi_step_entrance_form = new Application_Form_MultiStepEntranceExamForm();
        $dept_type = new Application_Model_DepartmentType();
        $this->view->form = $multi_step_entrance_form;
        $type = $this->_getParam("type");
        $edit_id = $this->_getParam("id");
        $dept_id = $this->_getParam("dept_id");
        $deptdetails = $dept_type->getRecord($dept_id);
        $this->view->type = $type;
        $academicYearModel = new Application_Model_AcademicYear();
                $yearId = $academicYearModel->getAcadYearId();
        switch ($type) {
            ...
            case "getStudents":
                ...
                $result = $paymentModel->getPaidRecordByCourse($dept_id,$yearId['year_id'],$deptdetails['degree_id']);
                //echo "<pre>";print_r($result);die;
                $page = $this->_getParam('page', 1);
                $paginator_data = array(
                    'page' => $page,
    ...
    public function ajaxInsertAddonsAction() {
        ...
        if ($this->_request->isPost() && $this->getRequest()->isXmlHttpRequest()) {
            $form_id = $this->_getParam("form_id");
            $course_id = $this->_getParam("course_id");
            $course_id1 = $this->_getParam("course_id1");
            $course_id2 = $this->_getParam("course_id2");
            $acad_id = $this->_getParam("acad_id");
           /// $acad_id='6';
            
            $update['status'] = 2;
            $addonModel->trashItems($form_id);
            // $courseAllotment->trashItems($form_id,$course_id1,$acad_id,$courseDetails['semester']);  
            if ($form_id) {
                foreach ($course_id as $val) {
                    $courseDetails = $addonCourseModel->getRecordbyacadid($val,$acad_id);
                    $data['stu_id'] = $form_id;
                    $data['addon_course_id'] = $val;
                    $data['addon_course_fee'] = $courseDetails['fee'];
                    $data['academic_year'] = $acad_id;
                    $addonModel->insert($data);
                     $coursedetails['course_details'] = $addonCourseModel->getRecords($acad_id);
                }
                // raushan kumar 12-07-2023 //
            //     if(!$course_id1)
            //   $courseAllotment->trashItems($form_id,$acad_id,'t1');  
            //      foreach ($course_id1 as $val) {
            //         $courseDetails = $valuecourse->getRecord($val);
            //         $data1['stu_id'] = $form_id;
            //         $data1['value_course_id'] = $val;
            //         $data1['sem'] = $courseDetails['semester'];
            //         $data1['academic_year'] = $acad_id;
                             
            //         $courseAllotment->insert($data1);
            //          $coursedetails['course_details1'] = $valuecourse->getRecords($acad_id);
            //     }
            //      // raushan kumar 12-07-2023 ///
            //      if(!$course_id2)
            //      $courseAllotment->trashItems($form_id,$acad_id,'t2'); 
            //      foreach ($course_id2 as $val) {
            //         $courseDetails = $valuecourse->getRecord($val); 
            //         $data2['stu_id'] = $form_id;
            //         $data2['value_course_id'] = $val;
            //         $data2['sem'] = $courseDetails['semester'];
            //          $data2['academic_year'] = $acad_id;
            //         $courseAllotment->insert($data2);
            //          $coursedetails['course_details2'] = $valuecourse->getRecords($acad_id);
            //     }
 ...
 public function ajaxInsertAddons2Action() {
        $addonModel = new Application_Model_AddonCourseAssignmentModel();
        $addonCourseModel = new Application_Model_AddonCourseModel();
        $valuecourse = new Application_Model_ValueAddedCourseModel();
        $courseAllotment = new Application_Model_ValueCoursesAllotmentModel();
...
///  Raushan value added course function 08-06-2023 ///
...
public function valueAddedCoursesAction() {
    ...
    'status' => $data['status'],
     ...
     $last_insert_id= $valueCourseData->update($updateData,array('id=?' => $edit_id));
      ...
      $this->_flashMessenger->addMessage('Value Added Course Updated Successfully added');
      $this->_redirect('entrance-report/value-added-courses');
    } else {
      $_SESSION['message_class'] = 'alert-danger';
      $this->_flashMessenger->addMessage('Invalid Token!  Not Updated');
...
public function ajaxGetValueCourseByYearAction() {
   ...
   public function valueAddedCoursesReportAction() {
       ...
       // $this->view->hod = $hoddetails;
        switch ($type) {
           ...
           $_SESSION['message_class'] = 'alert-success';
           $this->_flashMessenger->addMessage('Value Added Course Inserted Successfully added');
           $this->_redirect('entrance-report/value-added-courses-report');
           }else {
            $_SESSION['message_class'] = 'alert-danger';
            $this->_flashMessenger->addMessage('Deatils Already Exists! ');
            $this->_redirect('entrance-report/value-added-coursest');
      ...
      $this->_redirect('entrance-report/value-added-courses');
        ...
        break;
           case "getStudents":
                ...
                $dept_id = $this->_getParam("course_id");
                $acad_id = $this->_getParam("acad");
                $this->view->id = $dept_id;
                $result = $valueCourseData->getRecordByAddonCourse($dept_id,$acad_id);
              //  echo "<pre>";print_r($result);die;
                $page = $this->_getParam('page', 1);
                $paginator_data = array(
                    'page' => $page,
    ...
    public function ajaxGetValueCourseByYearReportAction() {
        $this->_helper->layout->disableLayout();
      $valueCourseData = new Application_Model_ValueAddedCourseModel();
