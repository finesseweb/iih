...
class AlumniassociationController extends Zend_Controller_Action {
          ...
          //   echo '<pre>'; print_r($data);exit;   
           ...
           $last_insert_id= $alumini_model->insert($data);
            ...
            date_default_timezone_set('Asia/Calcutta');
                        ...
                        $transactionRequest->setReturnUrl($this->_base_url  . 'alumniassociation/response/?id='.$last_insert_id);
                        ...
                        $transactionRequest->setCustomerBillingAddress($_POST['course']);
                        $transactionRequest->setCustomerId($_POST['batch']."|".'Alumni');
...
$transactionRequest->seturl("https://payment.atomtech.in/paynetz/epi/fts");
    ...
    $transactionRequest->setSalt("83D1E1EC3DEE483BB698935F9B312272");
            ...
            if($last_insert_id) {
                   $this->_redirect('alumniassociation/thankyou');
            }else{
