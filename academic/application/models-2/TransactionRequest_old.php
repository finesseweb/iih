 ...
 * Version 1.0
 */
class Application_Model_TransactionRequest extends Zend_Db_Table_Abstract 
{
    private $login;
    ...
    public function setCustomerAccount($customerAccount)
    {
     ...
     public function getCustomerRId()
    {
     ...
     * @param string $customerAccount
     */
    public function setCustomerRId($customerRId)
    {
    ...
    public function getCustomerEid()
    {
        return $this->customerEid;
    }

    /**
     * @param string $customerAccount
     */
    public function setCustomerEid($customerEid)
    {
    ...
    private function getData(){
       ...
       $strReqst .= "&udf9=".$this->getCustomerId();
