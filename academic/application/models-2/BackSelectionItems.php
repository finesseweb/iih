...
//echo $select; exit;
    ...
    public function getbackdata($session,$cmn_terms){
        $select = "SELECT erp_student_information.stu_fname,erp_student_information.reg_no,erp_student_information.student_id,erp_student_information.stu_id,erp_student_information.exam_roll,course_id,back_selection_items.ge_id ,course_master.course_code,term_master.term_id,erp_student_information.academic_id FROM `term_master`
,erp_elective_selection
,back_selection_items
,erp_student_information
,course_master
WHERE
erp_elective_selection.term_id =  term_master.term_id
...
and back_selection_items.elective_id = erp_elective_selection.elective_id
and back_selection_items.electives = course_master.course_id
and term_master.academic_year_id = erp_student_information.academic_id
and term_master.cmn_terms in $cmn_terms
and `session` = $session";
 $result = $this->getAdapter()
