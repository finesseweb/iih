...
public function gradeAllocationCourses($academic_year_id,$department_id,$employee_id,$term_id,$department = '',$paper_flg = 'R',$month="",$ge_id=0,$attend=false,$pay=false,$cmn_terms){
        ...
        left join  grade_allocation_master on grade_allocation_master.course_id = tmptb.course_id and grade_allocation_master.academic_id = $academic_year_id and grade_allocation_master.academic_id = $term_id and grade_allocation_master.flag not like  'b'
