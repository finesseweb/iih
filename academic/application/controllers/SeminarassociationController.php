<?php
class SeminarassociationController extends Zend_Controller_Action {
    ...
    public function indexAction() {
       ...
       $this->accessConfig->setAccess('SS_ALUM_AR');
        ...
        //echo '<pre>'; print_r($token);exit;
            ...
            $dirPath1 = realpath(APPLICATION_PATH . '/../public/seminar') .'/doc/';
          ...
          //   echo '<pre>'; print_r($data);exit;   
           ...
           $last_insert_id= $alumini_model->insert($data);
            ...
            date_default_timezone_set('Asia/Calcutta');
                        ...
                        $transactionRequest->setAmount($data['reg_amt']);
                        $transactionRequest->setTransactionCurrency("INR");
                        $transactionRequest->setTransactionAmount($data['reg_amt']);
                        $transactionRequest->setReturnUrl($this->_base_url  . 'seminarassociation/response/?id='.$last_insert_id);
                        ...
                        $transactionRequest->setCustomerMobile($_POST['number']);
                        $transactionRequest->setCustomerBillingAddress($_POST['theme']);
                        $transactionRequest->setCustomerId($_POST['designation']."|".'Seminar');
            ...
            if($last_insert_id) {
             //   die("updated");
                   $this->_redirect('seminarassociation/thankyou');
            }else{
