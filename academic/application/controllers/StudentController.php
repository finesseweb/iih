...
//                
    ...
    public function ajaxGetRecordByYearIdAction() {
        ...
        if ($this->_request->isPost() && $this->getRequest()->isXmlHttpRequest()) {
            $razor = new Application_Model_ApplicantRegisterationModel();
        ...
        $refgradeaddons  = new Application_Model_AddonMarksheets();
           ...
           $gradesvalues = $gradeskeys = array();
            ...
            if ($studetails){
                ...
                $this->_act->generateadmitcardPdfaddon($pdfheader, $pdffooter, $htmlcontent, $result['Name'] . $result['Form_Id'], 'P', 150);
                die;
            }
