...
if ($Mode=='ADD_ITEM' && can_process()) 
{
  ...
  //display_error($res[5]);
    if(($res[0] != $_POST['utly_type']) && ($res[3] != $_POST['utilitys_id']) && ($res[4] != $_POST['type_maintenance_id']) && ($res[5] != $_POST['frequency_id'])){
	//display_error('abc');
	...
	else if(($res[0] == $_POST['utly_type']) && ($res[1] == $_POST['utly_cat_id']) && ($res[2] == $_POST['utly_sub_cat_id']) && ($res[3] == $_POST['utilitys_id']) && ($res[4] == $_POST['type_maintenance_id']) && ($res[5] == $_POST['frequency_id'])){
	//display_error('32434');
