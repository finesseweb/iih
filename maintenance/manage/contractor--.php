...
include_once($path_to_root . "/maintenance/includes/ui/contacts_view.inc");
...
function supplier_settings(&$supplier_id)
{
	...
	else 
	{
		$_POST['supp_name'] = $_POST['supp_ref'] = $_POST['address'] = $_POST['supp_address'] = 
			$_POST['tax_group_id'] = $_POST['website'] =  $_POST['notes'] = '';
...
//	amount_row(_("Credit Limit:"), 'credit_limit', null);
	...
	//
	// tax_included option from Contractor record is used directly in update_average_cost() function,
	// therefore we can't edit the option after any transaction waas done for the Contractor.
	//
	...
	if ($input_error !=1 )
	{
		...
		if ($supplier_id) 
		{
			update_supplier($_POST['supplier_id'], $_POST['supp_name'], $_POST['supp_ref'], $_POST['address'],
				...
				$_POST['website'],  $_POST['bank_account'], $_POST['curr_code'],
