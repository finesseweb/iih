...
if ($Mode=='ADD_ITEM' || $Mode=='UPDATE_ITEM'){
	...
	if ($input_error != 1)	{
    	if ($selected_id != -1)     	{
    		update_tax_setup($selected_id, $_POST['description'], $_POST['type'],$_POST['allowance_credit_gl_code'], $_POST['allowance_debit_gl_code'], $_POST['inactive']);
			$note = _('Selected Allowance has been updated');
    	}     	else     	{
    		add_tax_setup($_POST['description'], $_POST['type'],$_POST['allowance_credit_gl_code'], $_POST['allowance_debit_gl_code'],$_POST['inactive']);
...
if($Mode == 'Edit')
	earning_deductions_list_row1(_("Type:"), 'type', null, "", "", false, $disabled,'1');
else
	earning_deductions_list_row1(_("Type:"), "type", null, "", "", false, false,'1');
