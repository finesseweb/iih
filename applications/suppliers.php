...
class suppliers_app extends application 
{
	function __construct() 
	{
		...
		$this->add_module(_("Transactions"));
                $this->add_lapp_function(0, _("&Indent"),
			"purchasing/po_entry_items.php?NewIndent=Yes", 'SA_PURCHASEENQUIRY', MENU_TRANSACTION);
		//$this->add_lapp_function(0, _("&RFQ"),
			//"purchasing/po_entry_items.php?NewEnquiry=Yes", 'SA_PURCHASEENQUIRY', MENU_TRANSACTION);
                $this->add_lapp_function(0, _("&RFQ PAGE"),
			"purchasing/po_entry_items.php?RFQ=Yes", 'SA_PURCHASEENQUIRY2', MENU_TRANSACTION);
		$this->add_lapp_function(0, _("Purchase &Quotation Entry"),
			"purchasing/po_entry_items.php?NewQuotation=Yes", 'SA_PURCHASEQUOTE', MENU_TRANSACTION);
		...
		$this->add_module(_("Inquiries and Reports"));
                $this->add_lapp_function(1, _("Indent Approvals"),
			"purchasing/inquiry/waiting_for_approvals.php?type=90", 'SA_SUPPTRANSVIEW', MENU_INQUIRY);
		$this->add_lapp_function(1, _("Purchase Indent &Inquiry"),
			"purchasing/inquiry/po_search_completed.php?type=90", 'SA_SUPPTRANSVIEW', MENU_INQUIRY);
		$this->add_lapp_function(1, _("RFQ &Inquiry"),
			"purchasing/inquiry/po_search_completed.php?type=60", 'SA_SUPPTRANSVIEW', MENU_INQUIRY);
		$this->add_lapp_function(1, _("Purchase Quotation &Inquiry"),
			"purchasing/inquiry/po_search_completed.php?type=70", 'SA_SUPPTRANSVIEW', MENU_INQUIRY);
		...
		$this->add_lapp_function(2, _("&Suppliers"),
			"purchasing/manage/suppliers.php?", 'SA_SUPPLIER', MENU_ENTRY);
                $this->add_rapp_function(2, _("&Suppliers TDS"),
			"tds/vendor.php?", 'SA_ADDTDS', MENU_TRANSACTION);
		$this->add_extensions();
	}
}
