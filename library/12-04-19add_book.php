...
//-----------------------------------------------------------------------------------
//===[Working]=====//
if(!isset($_POST['books_page_next']))
$_SESSION['fun']['id'] = 0;
start_form(true);
$sql = getBookList();
//$_SESSION['fun']['id'] = 0;
...
text_row(_('Book Title*'), 'title', $_POST['title'], 30);
//text_row(_('Category*'), 'category', $_POST['category'], 30);
book_category_list_cells12(_("Category:"), 'category', $_POST['category'], false, false);
text_row(_('Author*'), 'author', $_POST['author'], 30);
text_row(_('Publisher*'), 'publisher', $_POST['publisher'], 30);
//text_row(_('Published Date*'), 'published_date', $_POST['published_date'], 30);
//date_row(_("Published Date") . "", 'published_date');
date_cells(_("Published Date") . ":", 'published_date', null, null, 0, 0, 0, null,true);
text_row(_('Edition*'), 'edition', $_POST['edition'], 30);
text_row(_('No. of Copies*'), 'copies_no', $_POST['copies_no'], 30);
...
{
	$sql = "SELECT * FROM ".TB_PREF."book_category Where status=1";
