...
page(_($help_context = "Store Book to Shelf"), @$_REQUEST['popup'], false, "", $js);
...
//if(isset($_POST['self_code'])){
   ...
   start_table(TABLESTYLE);
    ...
    $result = get_ALLbookCopiesNumber(check_value('show_inactive'),$_POST['isbn']);
    while ($myrow = db_fetch($result)) {
        ...
        insert_books_copies($myrow["copies_no"], $myrow["map"], 'books_copies', 'copies_no',$myrow["ISBN"]);
