...
display_heading(get_product_name($woid)[1]);

br(1);
$myrow = get_building_order($woid);
...
br(1);
	...
	display_heading2(_("Issued Items"));
	display_building_requirements($woid, $myrow["units_reqd"]);
// 	if ($myrow["type"] == WO_ADVANCED)
// 	{
