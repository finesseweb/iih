...
if (isset($_POST['addissue']) && can_process())
{
	...
	$failed_data = add_seat_issues($_POST['seat'],
...
start_form();
display_search_details('S');
display_cat_details('S');
div_start('controls', 'items_table');
display_seat_requirements($_POST['seat'],'');
div_end();
$Ajax->activate('items_table');
echo "<br>";
...
display_issue_itemsm(_("Items to Issue"), $_SESSION['issue_items'],$_POST['group']);
