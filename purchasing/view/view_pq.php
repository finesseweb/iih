...
echo "<br>";
display_po_summary(70,$purchase_order, true);
...
$th = array(_("Item Code"), _("Item Descriptionrturtrturtu"), _("Quantity"), _("Unit"), _("Price"), _("GST"),_("CST"),_("IST"),
	 _("Line Total"));
table_header($th);
$total = $k = 0;
$overdue_items = false;
...
foreach ($purchase_order->line_items as $stock_item)
{
	...
	$line_total = $stock_item->quantity * ($stock_item->price+$stock_item->gst+$stock_item->cst+$stock_item->ist);
...
$tax_total = display_edit_tax_items($taxes, 5, $purchase_order->tax_included,2);
