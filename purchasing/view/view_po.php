...
echo "<br>";
display_po_summary(18,$purchase_order, true);
...
$th = array(_("Item Code"), _("Item Description"), _("Quantity"), _("Unit"), _("Price"), _("GST"), _("CST"), _("IST"),
	_("Expected  Delivery Date"), _("Line Total"), _("Quantity Received"), _("Quantity Invoiced"));
table_header($th);
$total = $k = 0;
$overdue_items = false;
