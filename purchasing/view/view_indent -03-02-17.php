...
page(_($help_context = "View Purchase Indent"), true, false, "", $js);


if (!isset($_GET['trans_no']))
{
	die ("<br>" . _("This page must be called with a purchase Indent number to review."));
}

display_heading(_("Purchase Indent") . " #" . $_GET['trans_no']);

$purchase_order = new purch_order;

read_po($_GET['trans_no'], $purchase_order);
echo "<br>";
display_po_summaries($purchase_order, true);
...
/* $th = array(_("Item Code"), _("Item Description"), _("Quantity"), _("Unit"), _("Price"),
	 _("Line Total")); */
	$th = array(_("Item_Code"), _("Item Description"), _("Quantity"));
table_header($th);
$total = $k = 0;
$overdue_items = false;
...
/* label_row(_("Sub Total"), $display_sub_tot,
	"align=right colspan=5", "nowrap align=right",2); */
