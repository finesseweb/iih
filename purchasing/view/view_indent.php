...
page(_($help_context = "View Purchase Indent"), true);
...
table_section(1);
label_row(_("Indent No.:"), 'IND-'.$row[4]);
label_row(_("Order Date"), sql2date($row[5]));
table_section(2);
...
//end_page(true, false, false, ST_PURCHINDENT, $trans_no);
?>