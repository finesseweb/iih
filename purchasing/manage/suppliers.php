...
if (isset($_GET['supplier_id'])) 
{
 ...
 if (isset($_POST['address_country'])) {
               ...
               $Ajax->activate('address_state');
        }
 if (isset($_POST['supp_country'])) {
                          $Ajax->activate('supp_address_state');
        }
...
function supplier_settings(&$supplier_id)
{
	...
	if ($supplier_id) 
	{
		...
		$_POST['bank_account']  = $myrow["bank_account"];
                ...
                $_POST['bank_ifsc']  = $myrow["bank_ifsc"];
		...
		$_POST['notes']  = $myrow["notes"];
	 	$_POST['inactive'] = $myrow["inactive"];
                $_POST['address_pin'] = $myrow["address_pin"];
              
                $_POST['address_state'] = $myrow["address_state"];
                $_POST['supp_address_state'] = $myrow["supp_address_state"];
                $_POST['supp_address_pin'] = $myrow["supp_address_pin"];
	} 
	else 
	{
	...
	vendors_list_row(_("Vendor Type:"), 'vendor_type', null);
	...
	text_row(_("Bank Account Number:"), 'bank_account_number', null, 42, 40);
        text_row(_("Bank Name:"), 'bank_name', null, 42, 40);
        text_row(_("IFSC code:"), 'bank_ifsc', null, 42, 40);
        text_row(_("Bank Account Title:"), 'bank_account', null, 42, 40);
	...
	textarea_row(_("Mailing Address:"), 'address', null, 35, 5);
        country_list_row(_("Country"), 'address_country', null, true, false);
            
              
       state_list_row(_("State / Union Territories:"), 'address_state', $_POST['address_state'], $_POST['address_country'], false, false);
        text_row(_("Pin Code:"), 'address_pin', null, 32, 30);
        textarea_row(_("Physical Address:"), 'supp_address', null, 35, 5);
        country_list_row(_("Country"), 'supp_country', null, true, false);
       state_list_row(_("State / Union Territories:"), 'supp_address_state', null, $_POST['supp_country'], false, false);
       
        text_row(_("Pin Code:"), 'supp_address_pin', null, 32, 30);
	...
	if ($input_error !=1 )
	{
		...
		if ($supplier_id) 
		{
			update_supplier($_POST['supplier_id'], $_POST['supp_name'], $_POST['supp_ref'], $_POST['address'],
				$_POST['supp_address'], $_POST['vendor_type'], $_POST['gst_no'],
				$_POST['website'], $_POST['supp_account_no'], $_POST['bank_account'],$_POST['bank_name'],$_POST['bank_account_number'],$_POST['bank_ifsc'], input_num('credit_limit', 0), $_POST['dimension_id'], $_POST['dimension2_id'], $_POST['curr_code'],$_POST['payment_terms'], $_POST['payable_account'], $_POST['purchase_account'], $_POST['payment_discount_account'],$_POST['notes'], $_POST['tax_group_id'], get_post('tax_included', 0),$_POST['address_pin'],$_POST['supp_address_pin'],$_POST['address_state'],$_POST['supp_address_state'],$_POST['address_country'],$_POST['supp_country']);
		...
		{
			add_supplier($_POST['supp_name'], $_POST['supp_ref'], $_POST['address'], $_POST['supp_address'],$_POST['address_state'],$_POST['supp_address_pin'], $_POST['vendor_type'],$_POST['gst_no'], $_POST['website'], $_POST['supp_account_no'], $_POST['bank_account'] ,$_POST['bank_name'],$_POST['bank_account_number'],$_POST['bank_ifsc'],input_num('credit_limit',0), $_POST['dimension_id'], $_POST['dimension2_id'],$_POST['curr_code'], $_POST['payment_terms'], $_POST['payable_account'], $_POST['purchase_account'],$_POST['payment_discount_account'], $_POST['notes'], $_POST['tax_group_id'], check_value('tax_included'),$_POST['address_pin'],$_POST['supp_address_pin'],$_POST['address_state'],$_POST['supp_address_state'],$_POST['address_country'],$_POST['supp_country']);
