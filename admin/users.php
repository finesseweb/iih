	...
	if (can_process($Mode == 'ADD_ITEM'))
	{
    	...
    	else 
    	{
    		add_user($_POST['user_id'], $_POST['real_name'], md5($_POST['password']),
				...
				$_POST['print_profile'], check_value('rep_popup'), $_POST['pos'],$_POST['empl_id']);
			$id = db_insert_id();
...
$th = array(_("Employee Id"),_("User login"), _("Full Name"), _("Phone"),
...
{ //end of if $selected_id only do the else when a new record is being entered
    employee_list_cells_active(_("Select an Employee: "), 'empl_id', $last_id,_('Select Employee'), false, check_value('show_inactive'));
...
//	$_POST['password'] = "";
//	text_row(_("Password:"), 'password', $password ,30,50);
}
$_POST['password'] = "";
