...
start_table(TABLESTYLE_NOBORDER);
start_row();
label_cell('<a  href="' . $path_to_root . '/modules/ExtendedHRM/reports/rep813.php?param_0=' . $year . '&param_1=' . $_POST['month'] . '&param_3=' . $selected_id . '" target="_blank" > <u>Print</u></a>');
end_row();
end_table();



//echo "<prE>"; print_r(get_tally_employees());exit;
